...
class TestCarrito(unittest.TestCase):
    ...
    # AsserIn (valida si un objeto existe en ...)
    def test_productosEnCarrito(self):
        itemInterno = Producto("Motocicleta", 1000)
        self.item2.carrito_agregar(itemInterno)
        self.assertIn(itemInterno, self.item2.productos)
    ...
    @unittest.skip("La prueba se va a saltar por que se desconoce su utilidad")
    def test_compra(self):
        self.assertGreater(20, 40)


    @unittest.skipIf(True, "La prueba se va a saltar por que se desconoce su utilidad")
    def test_compra2(self):
        self.assertGreater(20, 40)


    @unittest.skipUnless(False, "La prueba se va a saltar por que se desconoce su utilidad")
